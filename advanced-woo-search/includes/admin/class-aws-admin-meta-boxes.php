                        ...
                        $html .= '<div class="aws-welcome-panel-content">';
                            ...
                            $html .= '<div class="aws-welcome-panel-column-container">';
                                ...
                                $html .= '<div class="aws-welcome-panel-column">';
                                    ...
                                    $html .= '<ul>';
                                        $html .= '<li><a href="https://kramakit.com/guide/steps-to-get-started/" class="aws-welcome-icon aws-welcome-edit-page" target="_blank">' . __( 'Steps to Get Started', 'advanced-woo-search' ) . '</a></li>';
                                        $html .= '<li><a href="https://kramakit.com/guide/search-form/" class="aws-welcome-icon aws-welcome-edit-page" target="_blank">' . __( 'How to Add Search Form', 'advanced-woo-search' ) . '</a></li>';
                                        $html .= '<li><a href="https://kramakit.com/guide/search-source/" class="aws-welcome-icon aws-welcome-edit-page" target="_blank">' . __( 'Search Sources', 'advanced-woo-search' ) . '</a></li>';
                                        $html .= '<li><a href="https://kramakit.com/guide/terms-search/" class="aws-welcome-icon aws-welcome-edit-page" target="_blank">' . __( 'Terms Pages Search', 'advanced-woo-search' ) . '</a></li>';
                                    $html .= '</ul>';
                                $html .= '</div>';
                                $html .= '<div class="aws-welcome-panel-column aws-welcome-panel-last">';
                                    ...
                                    $html .= '<ul>';
                                        ...
                                        $html .= '<li><div class="aws-welcome-icon aws-welcome-widgets-menus"><a href="https://kramakit.com/contact/" target="_blank">' . __( 'Contact Form', 'advanced-woo-search' ) . '</a></div></li>';
                                    $html .= '</ul>';
                                $html .= '</div>';
                            $html .= '</div>';
                        $html .= '</div>';
            ...
            echo '<div id="aws-admin-header">';
                echo '<div class="inner">';
                    ...
                    echo '<div class="btns">';
                        ...
                        echo '<a class="button-docs" href="https://kramakit.com/guide-category/aws/?utm_source=wp-plugin&utm_medium=header&utm_campaign=guide" target="_blank">' . esc_html( 'Documentation', 'advanced-woo-search' ) . '</a>';
                        echo '<a class="button-support" href="https://kramakit.com/contact/?utm_source=wp-plugin&utm_medium=header&utm_campaign=support" target="_blank">' . esc_html( 'Support', 'advanced-woo-search' ) . '</a>';
